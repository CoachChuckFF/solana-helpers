...
exports.sleep = exports.updateSFT = exports.createSFT = exports.createSFTCollection = exports.getSFTData = exports.getCollectionData = exports.getMetadataMasterAccount = exports.getMetadataAccount = exports.getMetadataKey = exports.getMetadataMasterKey = exports.TEST_SPL_METADATA = exports.TEST_SPL_URL = exports.objToMetadata = exports.metadataToJson = exports.jsonToMetadata = exports.MetaCatagoryType = exports.MetaFileType = exports.disableSPLMint = exports.createSPL = exports.txSPL = exports.getAssociatedTokenAddressAndShouldCreate = exports.getAssociatedTokenAddress = exports.getSPLAccount = exports.burnFullToken = exports.closeSPLAccount = exports.burnSPL = exports.getRent = exports.dateToSolanaDate = exports.getProgram = exports.getSolanaProvider = exports.initSolanaProvider = exports.clusterToConnection = exports.SolanaCluster = exports.SPL_MINT_SPACE = exports.SIZE_STRING = exports.SIZE_U128 = exports.SIZE_U64 = exports.SIZE_U32 = exports.SIZE_U16 = exports.SIZE_U8 = exports.SIZE_VEC = exports.SIZE_PUBKEY = exports.ACCOUNT_DISCRIMINATOR_SIZE = void 0;
...
var SolanaClusterLocalnet = "http://localhost:8899";
...
var clusterToConnection = function (cluster, commitmentOrConfig) {
    ...
    if (commitmentOrConfig === void 0) { commitmentOrConfig = SolanaDefaultCommitment; }
    switch (cluster) {
        case SolanaCluster.localhost: return new anchor_1.web3.Connection(SolanaClusterLocalnet, commitmentOrConfig);
        case SolanaCluster.devnet: return new anchor_1.web3.Connection(SolanaClusterDevnet, commitmentOrConfig);
        case SolanaCluster.mainnet: return new anchor_1.web3.Connection(SolanaClusterDevnet, commitmentOrConfig);
        default: return SolanaConnectionDevnet;
    }
};
...
var initSolanaProvider = function (wallet, cluster, commitmentOrConfig, opts) {
    if (cluster === void 0) { cluster = SolanaCluster.mainnet; }
    if (commitmentOrConfig === void 0) { commitmentOrConfig = SolanaDefaultCommitment; }
    if (opts === void 0) { opts = { commitment: SolanaDefaultCommitment }; }
    return new anchor_1.Provider((0, exports.clusterToConnection)(cluster, commitmentOrConfig), wallet, opts);
};
...
var createSFT = function (provider, metadataURI, metadata, amount, existingCollection) { return __awaiter(void 0, void 0, void 0, function () {
    var owner, metadataStruct, splToken, collectionData, collectionMetadata, collection, creators, shareTally, hasOwner, _i, _a, creator, metadataData, metadataKey, createMetaTx, verifyCollectionTx, signMetadataTX, _b, _c;
    var _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
            ...
            case 4:
                collectionMetadata = _f.sent();
                if (collectionMetadata.data.symbol !== metadataStruct.symbol) {
                    throw new Error("Collection Symbol does not match...");
                }
                if ((_d = collectionMetadata.data.sellerFeeBasisPoints !== metadataStruct.sellerFeeBasisPoints) !== null && _d !== void 0 ? _d : 0) {
                ...
                return [4 /*yield*/, new meta.programs.metadata.DataV2({
                        ...
                        uri: metadataURI,
                        sellerFeeBasisPoints: (_e = metadataStruct.sellerFeeBasisPoints) !== null && _e !== void 0 ? _e : 0,
                        creators: creators,
                        collection: collection,
                        uses: null,
                    })];
            case 5:
                metadataData = _f.sent();
            ...
            case 8:
                ...
                return [4 /*yield*/, provider.send(signMetadataTX)];
            case 9:
                _f.sent();
                _c = (_b = console).log;
