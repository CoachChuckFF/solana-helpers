...
var clusterToConnection = function (cluster, commitmentOrConfig) {
    ...
    switch (cluster) {
        case SolanaCluster.localhost:
            return new anchor_1.web3.Connection(SolanaClusterLocalnet, commitmentOrConfig);
        case SolanaCluster.devnet:
            return new anchor_1.web3.Connection(SolanaClusterDevnet, commitmentOrConfig);
        ...
        return __generator(this, function (_a) {
            try {
                ...
                if (solana) {
                    if (solana.isPhantom) {
                        try {
                            solana.connect({ onlyIfTrusted: onlyIfTrusted }).then(function (result) {
...
var getSolanaProvider = function (wallet, isDevnet) {
    ...
    return new anchor_1.AnchorProvider(isDevnet ? SolanaConnectionDevnet : SolanaConnectionMainnet, wallet, {
